...
import { listOrders, type OrderResponse, type OrderStatus } from '../../api/ordersApi.ts'
        ...
        <table className="w-full text-left text-sm">
          ...
          <tbody>
            {isLoading ? (
              ...
              <tr><td colSpan={columns.length} className="p-6 text-center text-slate-500">No orders</td></tr>
            ) : (
